...
export default function Login() {
  ...
  async function sendAppeal() {
    ...
    if (r.ok) { toast.ok('Apelación enviada. Espera la revisión de un administrador.'); setAppeal(''); setBanned({ ...banned, can_appeal: false }); }
  }

  return (
    <div className="max-w-md mx-auto px-4 py-10">
      <h1 className="font-serif text-2xl font-bold mb-4">Iniciar sesión</h1>
      <form onSubmit={submit} className="rm-card p-6 space-y-3">
        ...
        <button className="rm-btn-primary w-full" type="submit">Entrar</button>
      ...
      {banned && (
        <div className="rm-card p-4 mt-4 border-l-4 border-red-700">
